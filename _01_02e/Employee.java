...
public class Employee {
  ...
  public static void main(String[] args) {
    ...
    // Create a variable called age of type int and assign it the value 30.
    int age1 = 30;
    int age2 = 18;
    ...
    double firstBonus = 10.00;
    double secondBonus= 22.00;
    double thirdBonus= 35.00;

    // Print out the sum of the variables called firstBonus, secondBonus and
    // thirdBonus.
    double totalPayment = firstBonus + secondBonus + thirdBonus;
